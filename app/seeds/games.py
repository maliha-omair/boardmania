...
def seed_games():
    ...
    game1 = Game(room_id=1, name="Game 001", game_status='onGoing', mode='twoPlayer')

    game2 = Game(room_id=1, name="Game 002", game_status='onGoing', mode='twoPlayer')

    game3 = Game(room_id=1, name="Game 003", game_status='done', mode='fourPlayer')

    game4 = Game(room_id=1, name="Game 004", game_status='done', mode='twoPlayer')
