...
class GamePlayer(db.Model):
    ...
    member = db.relationship("Member", back_populates="player",cascade="all, delete", lazy=False)
    game = db.relationship("Game", back_populates="player",cascade="all, delete", lazy=False)
