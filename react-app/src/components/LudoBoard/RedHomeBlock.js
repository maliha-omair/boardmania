...
export default function RedHomeBlock({s,x,y, legalMoves, currentPlayerColor, isMyTurn,  onPawnClick}) {
    return (
        <div className={[styles.border, styles.arrowDown,styles.endBlock].join(' ')} >
